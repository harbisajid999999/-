...
client.on('ready', () => {
  client.user.setGame(` *help  .`,'https://discord.gg/FgZQRK');
  console.log('---------------');
...
.setColor('RANDOM')
  message.author.sendEmbed(embed);
      ...
      .addField("** لاضافة البوت :wrench: **","** https://discordapp.com/oauth2/authorize?client_id=524669345335476224&permissions=268435488&scope=bot    **")
 }
});
client.on('message', message => {
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Vemo Bot- Script By : SAJED`);
        console.log(`----------------`);
